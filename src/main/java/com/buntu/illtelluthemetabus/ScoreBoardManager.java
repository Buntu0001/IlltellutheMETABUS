    ...
    public static void updateScoreBoard() {
        if (Bukkit.getOnlinePlayers().size() > 0) {
            ...
            for (int i = 0; i < sortList.size(); i++) {
                ...
                Score score = objective.getScore(Util.translate(String.format("&a%s: &c%d&7점", ChatColor.stripColor(questionPlayerState.getPlayer().getDisplayName()), questionPlayerState.getPlayerScore())));
